...
if (siteHeaderElement) {
  siteHeaderElement.innerHTML = `<nav class="nav shell" aria-label="Main navigation">
    ...
    <div class="nav-menu" id="nav-menu"><a href="${navRoot}our-story.html">Our Story</a><a href="${navRoot}work.html?v=30">Work</a>${servicesMegaNav}<a href="${navRoot}industries.html">Industries</a><a href="${navRoot}case-studies.html">Case Studies</a><a href="${navRoot}resources.html">Resources</a></div>
