# Services landing-page design review

Ten review-only Services landing-page concepts are available from `services-design-options.html`.
The production `services.html` is unchanged.
...
Validation: all 10 concepts checked at 1440, 768, and 390px for horizontal overflow, service coverage, image loading, links, anchors, and shared footer. Interactive priority tabs, service tabs, and service accordions were exercised. The gallery and concept selector were checked separately.
