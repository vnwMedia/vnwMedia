...
function header(){
  return `<header class="site-header"><nav class="nav shell" aria-label="Main navigation">
    ...
    <div class="nav-menu" id="nav-menu"><a href="${path("our-story.html")}">Our Story</a>${servicesMega()}<a href="${path("work.html?v=31")}">Our Work</a><a href="${path("industries.html")}">Industries</a><a href="${path("resources.html")}">Resources</a></div>
...
function footer(){
  return `<footer class="footer"><div class="shell footer-grid">
    ...
    <div><h4>Company</h4><a href="${path("case-studies.html")}">Case Studies</a><a href="${path("our-story.html#process")}">Process</a><a href="${path("clients.html")}">Reviews</a><a href="${path("resources.html#faq")}">FAQ</a><a href="${path("contact.html")}">Contact</a><a href="${path("resources.html")}">Resources</a></div>
    <div><h4>Contact</h4><span>contactus@vnwmedia.com</span><span>(732) 820-0609</span><span>Morganville, NJ 07751</span></div>
  </div><div class="shell copyright"><span>© 2026 VNW Media LLC. All rights reserved.</span><a href="#top">Back to top ↑</a></div></footer>`;
}
...
function topPage(id){
  ...
  if(id==="contact") body=contact()+googleTestimonials("contact-reviews").replace('data-nav-theme="dark"','data-nav-theme="light"');
  return hero(...p)+body;
}
