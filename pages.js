...
function header(){
  return `<header class="site-header"><nav class="nav shell" aria-label="Main navigation">
    ...
    <div class="nav-menu" id="nav-menu"><a href="${path("our-story.html")}">Our Story</a>${servicesMega()}<a href="${path("work.html?v=31")}">Our Work</a><a href="${path("industries.html")}">Industries</a><a href="${path("case-studies.html")}">Case Studies</a><a href="${path("resources.html")}">Resources</a></div>
