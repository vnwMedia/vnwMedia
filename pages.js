...
function workPageOne(){
  ...
  <section class="work-agency-process section" id="work-process" data-nav-theme="light"><div class="shell"><div class="work-agency-process-head reveal"><p class="section-tag">How Projects Move</p><h2>A clear path from the first conversation to the next improvement.</h2></div><div class="work-agency-process-grid">${processSteps.map((x,i)=>`<article class="reveal" style="--process-image:url('${img(x[2])}')"><span>${String(i+1).padStart(2,"0")}</span><h3>${x[0]}</h3><p>${x[1]}</p></article>`).join("")}</div><div class="work-agency-process-cta reveal"><div><span>Ready for the next step?</span><p>Move your project from discovery to measurable improvement.</p></div><a class="pill pill-blue" href="${path("contact.html")}">Plan your project <span>↗</span></a></div></div></section>
  ${googleTestimonials()}
  ${workFAQ()}
