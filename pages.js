...
function footer(includeMobilePlan=true){
  ...
  </div><div class="shell copyright"><span>© 2026 VNW Media LLC. All rights reserved.</span><a href="#top">Back to top ↑</a></div></footer>${includeMobilePlan?`<a class="mobile-plan" href="${path("contact.html")}">Let’s Talk About Your Project</a>`:""}`;
}
...
function bootPages(){
  ...
  app.innerHTML=header()+`<main>${content}</main>`+footer(id!=="story");
}
bootPages();
