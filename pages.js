...
function footer(){
  return `<footer class="footer"><div class="shell footer-grid">
    ...
    <div><h4>Company</h4><a href="${path("case-studies.html?v=16")}">Case Studies</a><a href="${path("our-story.html#process")}">Process</a><a href="${path("clients.html")}">Reviews</a><a href="${path("resources.html#faq")}">FAQ</a><a href="${path("contact.html")}">Contact</a><a href="${path("resources.html")}">Blog</a></div>
...
function googleTestimonials(sectionId="reviews"){
  ...
  return `<section class="testimonials testimonial-ticker-section section" id="${sectionId}" data-nav-theme="dark"><div class="shell testimonial-ticker-shell"><div class="testimonial-ticker-heading reveal"><div><p class="section-tag">Client Feedback</p><h2>Trusted by the people behind growing businesses.</h2></div><div class="testimonial-google-summary" aria-label="4.9 out of 5 stars on Google"><div><img src="${img("assets/google-g-logo.png")}" alt="Google"><span>★★★★★</span></div><p><strong>4.9</strong> on Google</p></div></div></div><div class="testimonial-ticker-viewport" data-testimonial-ticker aria-label="Recent Google review excerpts"><div class="testimonial-ticker-track">${reviews.map(x=>`<article class="testimonial-ticker-card"><div class="testimonial-card-top"><span>Google review</span><span>★★★★★</span></div><blockquote>“${x[1]}”</blockquote><footer><strong>${x[0]}</strong></footer></article>`).join("")}</div></div><div class="shell testimonial-ticker-footer"><a href="https://www.google.com/maps/search/?api=1&amp;query=VNW+Media&amp;query_place_id=ChIJH8x-SSDNw4kRL5QM6uUWIV4" target="_blank" rel="noopener">Read all Google reviews <span>↗</span></a></div></section>`;
}
