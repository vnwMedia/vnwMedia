...
const topPages = {
  ...
  work:["Our Work","Websites and marketing systems built to earn the next customer.","Selected work across automotive, home services, healthcare, legal, restaurant, daycare, retail, and professional services—shaped around trust, visibility, and a clearer path to action.","assets/work-hero-creative-studio.jpg"],
  ...
  "work-process-modern-options":["Modern Process Options","Ten modern directions for showing how projects move.","Full-width, image-led section concepts built around Discover, Shape, Build, and Improve.","assets/work-process-build.jpg"],
  "our-process-design-options":["Our Process Design Options","Ten creative directions for presenting the VNW Media process.","Full-width concepts built around Discover, Strategize, Create, Launch, and Improve.","assets/work-process-discover.jpg"],
...
function header(){
  return `<header class="site-header"><nav class="nav shell" aria-label="Main navigation">
    ...
    <div class="nav-menu" id="nav-menu"><a href="${path("our-story.html")}">Our Story</a><a href="${path("work.html?v=30")}">Work</a>${servicesMega()}<a href="${path("industries.html")}">Industries</a><a href="${path("case-studies.html")}">Case Studies</a><a href="${path("resources.html")}">Resources</a></div>
...
function footer(){
  return `<footer class="footer"><div class="shell footer-grid">
    <div class="footer-about"><img src="${img("assets/vnwMedia-LogoBlk.png?v=127")}" alt="VNW Media"><p>New Jersey’s full-service web and digital marketing company. Strategy, creative, and campaigns that move business forward.</p><div class="social" aria-label="VNW Media social profiles"><a href="https://www.instagram.com/vnwmediallc/" aria-label="Instagram" title="Instagram"><svg viewBox="0 0 24 24" aria-hidden="true"><rect x="3" y="3" width="18" height="18" rx="5" fill="none" stroke="currentColor" stroke-width="1.8"/><circle cx="12" cy="12" r="4" fill="none" stroke="currentColor" stroke-width="1.8"/><circle cx="17.4" cy="6.7" r="1" fill="currentColor"/></svg></a><a href="https://www.linkedin.com/company/vnw-media-llc" aria-label="LinkedIn" title="LinkedIn"><svg viewBox="0 0 24 24" aria-hidden="true"><path fill="currentColor" d="M6.5 8.2H3.4V18h3.1V8.2Zm.2-3a1.8 1.8 0 1 0-3.6 0 1.8 1.8 0 0 0 3.6 0ZM18.9 12.4c0-3-1.6-4.4-3.8-4.4-1.7 0-2.5 1-2.9 1.6V8.2H9.1V18h3.1v-4.9c0-1.3.2-2.6 1.9-2.6 1.6 0 1.7 1.5 1.7 2.7V18h3.1v-5.6Z"/></svg></a><a href="https://www.facebook.com/vnwmedia/" aria-label="Facebook" title="Facebook"><svg viewBox="0 0 24 24" aria-hidden="true"><path fill="currentColor" d="M14.2 8.2V6.5c0-.8.5-1 1.1-1h2.6V2h-3.6C10.9 2 10 4 10 6.2v2H7.6v3.9H10V22h4.2v-9.9h3.1l.5-3.9h-3.6Z"/></svg></a></div></div>
    <div><h4>Services</h4><a href="${path("services/web-design.html")}">Web Design</a><a href="${path("services/seo.html")}">SEO</a><a href="${path("services/google-ppc.html")}">Google PPC</a><a href="${path("services/social-media.html")}">Social Media</a><a href="${path("services/brand-strategy.html")}">Brand Strategy</a></div>
    <div><h4>Company</h4><a href="${path("case-studies.html")}">Case Studies</a><a href="${path("our-story.html#process")}">Process</a><a href="${path("clients.html")}">Reviews</a><a href="${path("resources.html#faq")}">FAQ</a><a href="${path("contact.html")}">Contact</a><a href="${path("resources.html")}">Blog</a></div>
...
function workPageOne(){
  ...
  const processSteps=[
    ["Discover","Review the business, customer journey, current site, competition, proof, and growth priorities.","assets/work-process-discover.jpg"],
    ["Shape","Define the message, page structure, design direction, content needs, and conversion paths.","assets/work-process-shape.jpg"],
  ...
  return `<section class="work work-agency-featured section" id="page-content"><div class="shell"><div class="work-agency-head reveal"><div><p class="section-tag">Selected Work</p><h2>Different industries. The same focus on clarity, trust, and action.</h2></div><p>Each project begins with a different business problem. The work below shows how strategy, design, content, search context, and lead paths come together around the customer’s next decision.</p></div><div class="work-grid">${DATA.cases.map((x,i)=>`<article class="work-card work-agency-card reveal">${["la-rosa-chicken-grill","brooklyn-motors"].includes(x[1])?`<figure class="work-client-media"><img src="${img(x[4])}" alt="${esc(x[0])}"><img class="work-client-logo" src="${img(x[1]==="brooklyn-motors"?"assets/brooklyn-motors-logo-supplied.png":"assets/la-rosa-logo-supplied.png")}" alt="${esc(x[0])} logo"></figure>`:`<img src="${img(x[4])}" alt="${esc(x[0])}">`}<div><span>${esc(x[2])}</span><h3>${esc(x[0])}</h3><p>${esc(x[3])}</p><ul aria-label="Services provided for ${esc(x[0])}">${projectScopes[i].map(scope=>`<li><a class="work-service-pill" href="${path(`services/${scopePages[scope]}.html`)}">${scope}</a></li>`).join("")}</ul><a class="work-case-link" href="${path(`case-studies/${x[1]}.html`)}" aria-label="Read ${esc(x[0])} case study"><b>Read case study ↗</b></a></div></article>`).join("")}</div><div class="portfolio-list reveal">${moreWork.map((x,i)=>`<a href="${path("contact.html")}"><span>${String(i+4).padStart(2,"0")}</span><strong>${x}</strong><i>Discuss this work ↗</i></a>`).join("")}</div></div></section>
...
function nextChapterCTA(contactHref=path("contact.html")){
  return `<section class="next-chapter-cta" id="next-chapter" data-nav-theme="light"><div class="next-chapter-banner reveal"><img src="${img("assets/story-hero-digital-option-1-monitor-collaboration.png")}" alt="Digital agency team collaborating around website designs and performance dashboards"><div class="next-chapter-copy"><p class="section-tag">Launch your next chapter</p><h2>Ready for your next stage of <em>growth?</em></h2><div class="next-chapter-actions"><a class="pill pill-blue pill-large" href="${contactHref}">Get Your Strategy <span>↗</span></a><a class="pill pill-outline pill-large" href="tel:17328200609">Call Us Now</a></div></div></div></section>`;
}
...
function googleTestimonials(sectionId="reviews"){
  const reviews=[
  ...
  return `<section class="testimonials testimonial-ticker-section section" id="${sectionId}" data-nav-theme="dark"><div class="shell testimonial-ticker-shell"><div class="testimonial-ticker-heading reveal"><div><p class="section-tag">Client Feedback</p><h2>Trusted by the people behind growing businesses.</h2></div><div class="testimonial-google-summary" aria-label="4.9 out of 5 stars on Google"><div><img src="${img("assets/google-g-logo.png")}" alt="Google"><span>★★★★★</span></div><p><strong>4.9</strong> on Google</p></div></div></div><div class="testimonial-ticker-viewport" data-testimonial-ticker aria-label="Google reviews and excerpts"><div class="testimonial-ticker-track">${reviews.map(x=>`<article class="testimonial-ticker-card"><div class="testimonial-card-top"><span>Google review</span><span>★★★★★</span></div><blockquote>“${x[1]}”</blockquote><footer><strong>${x[0]}</strong></footer></article>`).join("")}</div></div><div class="shell testimonial-ticker-footer"><a href="https://www.google.com/maps/search/?api=1&amp;query=VNW+Media&amp;query_place_id=ChIJH8x-SSDNw4kRL5QM6uUWIV4" target="_blank" rel="noopener">Read all Google reviews <span>↗</span></a></div></section>`;
}

function testimonials(){
  return googleTestimonials("page-content");
}
...
function workProcessModernOptions(){
  const steps=[
    ["Discover","Review the business, customer journey, current site, competition, proof, and growth priorities.","assets/work-process-discover.jpg"],
    ["Shape","Define the message, page structure, design direction, content needs, and conversion paths.","assets/work-process-shape.jpg"],
    ["Build","Bring design, copy, development, SEO foundations, tracking, and launch details together.","assets/work-process-build.jpg"],
    ["Improve","Use customer questions and performance signals to guide the next useful refinement.","assets/work-process-improve.jpg"]
  ];
  const optionLabel=(number,name,tone)=>`<div class="wpm-option-label"><span>${number}</span><strong>${name}</strong><small>${tone}</small></div>`;
  const action=`<a class="pill pill-blue" href="${path("contact.html")}">Plan your project <span>↗</span></a>`;
  const optionNames=["Editorial Frames","Split Sequence","Panoramic Rail","Modular Board","Studio Index","Horizon Timeline","Cinematic Panels","Blueprint Flow","Layered Sequence","Immersive Chapters"];
  return `<section class="wpm-review-hero" id="top" data-nav-theme="light"><div class="shell"><p class="section-tag">Process Section Study</p><h1>Ten full-width ways to show how projects move.</h1><p>Each direction keeps the same four phases and compact CTA while changing the rhythm, imagery, and level of visual impact.</p><nav class="wpm-jump" aria-label="Process concept options">${optionNames.map((name,index)=>`<a href="#process-option-${index+1}"><span>${String(index+1).padStart(2,"0")}</span>${name}</a>`).join("")}</nav></div></section>
  <section class="wpm-option wpm-editorial" id="process-option-1" data-nav-theme="light"><div class="shell">${optionLabel("01","Editorial Frames","Light · Image-led · Familiar")}</div><div class="wpm-editorial-stage"><div class="shell"><header><div><p class="section-tag">How Projects Move</p><h2>From first question to the next improvement.</h2></div>${action}</header><div class="wpm-editorial-grid">${steps.map((step,index)=>`<article><figure><img src="${img(step[2])}" alt="${step[0]} project phase"><span>0${index+1}</span></figure><h3>${step[0]}</h3><p>${step[1]}</p></article>`).join("")}</div></div></div></section>
  <section class="wpm-option wpm-split" id="process-option-2" data-nav-theme="dark"><div class="shell">${optionLabel("02","Split Sequence","Dark · Structured · Full-width")}</div><div class="wpm-split-stage"><div class="shell wpm-split-layout"><aside><p class="section-tag">How Projects Move</p><h2>One clear decision at a time.</h2><p>Keep the promise visible while the four phases unfold as a concise working sequence.</p>${action}</aside><div class="wpm-split-list">${steps.map((step,index)=>`<article><img src="${img(step[2])}" alt=""><span>0${index+1}</span><div><h3>${step[0]}</h3><p>${step[1]}</p></div></article>`).join("")}</div></div></div></section>
  <section class="wpm-option wpm-panorama" id="process-option-3" data-nav-theme="dark"><div class="shell">${optionLabel("03","Panoramic Rail","Cinematic · Edge-to-edge · Concise")}</div><div class="wpm-panorama-stage" style="--wpm-image:url('${img("assets/work-process-build.jpg")}')"><div class="shell wpm-panorama-inner"><div class="wpm-panorama-head"><div><p class="section-tag">How Projects Move</p><h2>Four connected phases.<br>One working system.</h2></div>${action}</div><div class="wpm-panorama-steps">${steps.map((step,index)=>`<article><span>0${index+1}</span><h3>${step[0]}</h3><p>${step[1]}</p></article>`).join("")}</div></div></div></section>
  <section class="wpm-option wpm-modular" id="process-option-4" data-nav-theme="light"><div class="shell">${optionLabel("04","Modular Board","Bento · Flexible · Modern")}</div><div class="wpm-modular-stage"><div class="shell"><div class="wpm-modular-head"><div><p class="section-tag">How Projects Move</p><h2>A process built from connected working blocks.</h2></div><p>Every phase has its own job, but the value comes from how the decisions connect.</p>${action}</div><div class="wpm-modular-grid">${steps.map((step,index)=>`<article class="wpm-module-${index+1}" style="--wpm-card:url('${img(step[2])}')"><span>0${index+1}</span><div><h3>${step[0]}</h3><p>${step[1]}</p></div></article>`).join("")}</div></div></div></section>
  <section class="wpm-option wpm-index" id="process-option-5" data-nav-theme="light"><div class="shell">${optionLabel("05","Studio Index","Minimal · Precise · Premium")}</div><div class="wpm-index-stage"><div class="shell"><header><div><p class="section-tag">How Projects Move</p><h2>The process, without the excess.</h2></div><p>A clean index gives each phase equal weight and keeps the entire story visible at a glance.</p></header><div class="wpm-index-list">${steps.map((step,index)=>`<article><span>0${index+1}</span><img src="${img(step[2])}" alt=""><h3>${step[0]}</h3><p>${step[1]}</p></article>`).join("")}</div><footer><p>Ready to move from discovery to measurable improvement?</p>${action}</footer></div></div></section>
  <section class="wpm-option wpm-horizon" id="process-option-6" data-nav-theme="dark"><div class="shell">${optionLabel("06","Horizon Timeline","Linear · Spacious · Confident")}</div><div class="wpm-horizon-stage"><div class="shell"><header><div><p class="section-tag">How Projects Move</p><h2>A visible path from insight to improvement.</h2></div>${action}</header><div class="wpm-horizon-track">${steps.map((step,index)=>`<article><span>0${index+1}</span><img src="${img(step[2])}" alt=""><div><h3>${step[0]}</h3><p>${step[1]}</p></div></article>`).join("")}</div></div></div></section>
  <section class="wpm-option wpm-panels" id="process-option-7" data-nav-theme="dark"><div class="shell">${optionLabel("07","Cinematic Panels","Immersive · Vertical · Image-first")}</div><div class="wpm-panels-stage">${steps.map((step,index)=>`<article style="--wpm-panel:url('${img(step[2])}')"><div><span>0${index+1}</span><h3>${step[0]}</h3><p>${step[1]}</p></div></article>`).join("")}</div><div class="shell wpm-panels-action"><p>Four phases. One connected delivery system.</p>${action}</div></section>
  <section class="wpm-option wpm-blueprint" id="process-option-8" data-nav-theme="light"><div class="shell">${optionLabel("08","Blueprint Flow","Technical · Airy · Systematic")}</div><div class="wpm-blueprint-stage"><div class="shell"><header><div><p class="section-tag">How Projects Move</p><h2>Clear inputs. Connected decisions. Better outcomes.</h2></div><p>Each phase hands useful context to the next, so strategy does not get lost between disciplines.</p></header><div class="wpm-blueprint-flow">${steps.map((step,index)=>`<article><span>0${index+1}</span><div><h3>${step[0]}</h3><p>${step[1]}</p></div></article>`).join("")}</div><footer>${action}</footer></div></div></section>
  <section class="wpm-option wpm-stack" id="process-option-9" data-nav-theme="dark"><div class="shell">${optionLabel("09","Layered Sequence","Editorial · Horizontal · Bold")}</div><div class="wpm-stack-stage"><div class="shell wpm-stack-head"><div><p class="section-tag">How Projects Move</p><h2>Every layer earns the next.</h2></div>${action}</div><div class="wpm-stack-list">${steps.map((step,index)=>`<article><div class="shell"><span>0${index+1}</span><h3>${step[0]}</h3><p>${step[1]}</p><img src="${img(step[2])}" alt=""></div></article>`).join("")}</div></div></section>
  <section class="wpm-option wpm-immersive" id="process-option-10" data-nav-theme="dark"><div class="shell">${optionLabel("10","Immersive Chapters","Atmospheric · Large-scale · Premium")}</div><div class="wpm-immersive-stage" style="--wpm-image:url('${img("assets/work-process-discover.jpg")}')"><div class="shell"><header><p class="section-tag">How Projects Move</p><h2>Start with clarity.<br>Keep building from there.</h2></header><div class="wpm-immersive-steps">${steps.map((step,index)=>`<article><span>0${index+1}</span><h3>${step[0]}</h3><p>${step[1]}</p></article>`).join("")}</div><footer>${action}</footer></div></div></section>`;
}

function ourProcessDesignOptions(){
  const steps=[
    ["Discover","We learn your offer, audience, competitors, goals, current performance, and where prospects are getting lost.","assets/work-process-discover.jpg"],
    ["Strategize","We define the message, customer journey, channel mix, project priorities, and measurements that matter.","assets/work-process-shape.jpg"],
    ["Create","Design, content, development, SEO, and campaigns come together as one consistent experience.","assets/work-process-build.jpg"],
    ["Launch","We test the details, connect tracking, prepare your team, and take the new system live with confidence.","assets/work-hero-creative-studio.jpg"],
    ["Improve","Performance insights guide practical refinements that strengthen traffic quality, engagement, and conversion.","assets/work-process-improve.jpg"]
  ];
  const label=(number,name,tone)=>`<div class="opd-label"><span>${number}</span><strong>${name}</strong><small>${tone}</small></div>`;
  const action=`<a class="pill pill-blue" href="${path("contact.html")}">Discuss your project <span>↗</span></a>`;
  const names=["Electric Index","Night Sequence","Editorial Cards","Cinematic Rail","Signal Timeline","Split Manifesto","Image Chapters","Blueprint System","Progressive Bands","Launch Matrix"];
  return `<section class="opd-review-hero" id="top" data-nav-theme="light"><div class="shell"><p class="section-tag">Our Process · Design Study</p><h1>Ten creative ways to make the process feel clear and memorable.</h1><p>Every option uses the same five phases. The difference is how typography, imagery, color, spacing, and sequence shape the experience.</p><nav class="opd-jump" aria-label="Our Process design options">${names.map((name,index)=>`<a href="#process-design-${index+1}"><span>${String(index+1).padStart(2,"0")}</span>${name}</a>`).join("")}</nav></div></section>
  <section class="opd-option opd-electric" id="process-design-1" data-nav-theme="light"><div class="shell">${label("01","Electric Index","Bold · Direct · Brand-led")}<div class="opd-electric-head"><div><p class="section-tag">Our Process</p><h2>A clear path from business challenge to digital growth.</h2></div><p>No mystery retainers. No design for design’s sake. Every phase has a purpose, an output, and a clear next step.</p></div><div class="opd-electric-list">${steps.map((step,index)=>`<article><span>0${index+1}</span><h3>${step[0]}</h3><p>${step[1]}</p></article>`).join("")}</div></div></section>
  <section class="opd-option opd-night" id="process-design-2" data-nav-theme="dark"><div class="shell">${label("02","Night Sequence","Dark · Structured · Technical")}<div class="opd-night-grid"><header><p class="section-tag">Our Process</p><h2>Five connected decisions. One stronger system.</h2><p>Strategy stays visible from the first conversation through launch and refinement.</p>${action}</header><div class="opd-night-list">${steps.map((step,index)=>`<article><img src="${img(step[2])}" alt=""><span>0${index+1}</span><div><h3>${step[0]}</h3><p>${step[1]}</p></div></article>`).join("")}</div></div></div></section>
  <section class="opd-option opd-editorial" id="process-design-3" data-nav-theme="light"><div class="shell">${label("03","Editorial Cards","Warm · Tactile · Human")}<header><div><p class="section-tag">Our Process</p><h2>Good work moves through clear chapters.</h2></div><p>Each phase has a focused purpose, but the value comes from the way every decision carries forward.</p></header><div class="opd-editorial-grid">${steps.map((step,index)=>`<article><figure><img src="${img(step[2])}" alt="${step[0]} phase"><span>0${index+1}</span></figure><h3>${step[0]}</h3><p>${step[1]}</p></article>`).join("")}</div><footer>${action}</footer></div></section>
  <section class="opd-option opd-cinema" id="process-design-4" data-nav-theme="dark" style="--opd-bg:url('${img("assets/work-process-build.jpg")}')"><div class="shell">${label("04","Cinematic Rail","Immersive · Layered · Confident")}<div class="opd-cinema-copy"><p class="section-tag">Our Process</p><h2>From the first signal to the next opportunity.</h2>${action}</div><div class="opd-cinema-rail">${steps.map((step,index)=>`<article><span>0${index+1}</span><h3>${step[0]}</h3><p>${step[1]}</p></article>`).join("")}</div></div></section>
  <section class="opd-option opd-timeline" id="process-design-5" data-nav-theme="light"><div class="shell">${label("05","Signal Timeline","Minimal · Linear · Precise")}<header><p class="section-tag">Our Process</p><h2>A visible sequence with no missing steps.</h2><p>Each handoff preserves the context, intent, and measurement needed for the next decision.</p></header><div class="opd-timeline-track">${steps.map((step,index)=>`<article><span>0${index+1}</span><h3>${step[0]}</h3><p>${step[1]}</p></article>`).join("")}</div><footer>${action}</footer></div></section>
  <section class="opd-option opd-split" id="process-design-6" data-nav-theme="dark"><div class="opd-split-color"><div class="shell">${label("06","Split Manifesto","Graphic · Contrasting · Editorial")}<p class="section-tag">Our Process</p><h2>Clear thinking on one side.<br>Focused execution on the other.</h2><p>The process keeps creative ambition connected to business priorities.</p>${action}</div></div><div class="opd-split-steps">${steps.map((step,index)=>`<article><span>0${index+1}</span><div><h3>${step[0]}</h3><p>${step[1]}</p></div></article>`).join("")}</div></section>
  <section class="opd-option opd-panels" id="process-design-7" data-nav-theme="dark"><div class="shell">${label("07","Image Chapters","Visual · Expansive · Story-led")}</div><div class="opd-panels-grid">${steps.map((step,index)=>`<article style="--opd-image:url('${img(step[2])}')"><div><span>0${index+1}</span><h3>${step[0]}</h3><p>${step[1]}</p></div></article>`).join("")}</div><div class="shell opd-panels-footer"><p>Five phases. One connected growth system.</p>${action}</div></section>
  <section class="opd-option opd-blueprint" id="process-design-8" data-nav-theme="light"><div class="shell">${label("08","Blueprint System","Systematic · Airy · Detailed")}<header><div><p class="section-tag">Our Process</p><h2>Every phase creates the inputs for the next.</h2></div><p>A connected process protects good decisions from being lost between strategy, creative, technology, and launch.</p></header><div class="opd-blueprint-flow">${steps.map((step,index)=>`<article><span>0${index+1}</span><h3>${step[0]}</h3><p>${step[1]}</p></article>`).join("")}</div><footer>${action}</footer></div></section>
  <section class="opd-option opd-bands" id="process-design-9" data-nav-theme="dark"><div class="shell">${label("09","Progressive Bands","Oversized · Rhythmic · Bold")}<header><div><p class="section-tag">Our Process</p><h2>Momentum you can see.</h2></div>${action}</header></div><div class="opd-band-list">${steps.map((step,index)=>`<article><div class="shell"><span>0${index+1}</span><h3>${step[0]}</h3><p>${step[1]}</p><img src="${img(step[2])}" alt=""></div></article>`).join("")}</div></section>
  <section class="opd-option opd-matrix" id="process-design-10" data-nav-theme="dark"><div class="shell">${label("10","Launch Matrix","Modern · Modular · Performance-led")}<header><p class="section-tag">Our Process</p><h2>Build the system.<br>Launch with confidence.<br>Keep improving.</h2><p>Five phases connect business strategy, creative execution, delivery, and performance into one practical operating rhythm.</p></header><div class="opd-matrix-grid">${steps.map((step,index)=>`<article style="--opd-image:url('${img(step[2])}')"><span>0${index+1}</span><div><h3>${step[0]}</h3><p>${step[1]}</p></div></article>`).join("")}</div><footer>${action}</footer></div></section>`;
}
...
function serviceDiagnosticCTA(service){
  const conceptByService={
    ...
    "seo":"search","geo":"search","content-writing":"search",
    "yelp-seo":"local","google-business-profile":"local",
    "reputation-management":"reputation",
    "lead-generation":"growth","google-ppc":"campaign","paid-social":"campaign",
    "crm-automation":"followup","email-marketing":"followup","text-marketing":"followup"
  };
  const concepts={
    website:{number:"01",eyebrow:"Website clarity check",title:"Is your website helping customers choose you?",body:"See how clearly the experience communicates, builds trust, performs on mobile, and moves visitors toward the next step.",button:"Check my website",proof:["Five-minute check","Clear score","Prioritized fixes"]},
    local:{number:"02",eyebrow:"Local visibility check",title:"Can nearby customers find you first?",body:"Preview how your business appears across local search, Maps, reviews, and the service areas that matter most.",button:"Check my local visibility",proof:["Search presence","Maps coverage","Review strength"]},
    lead:{number:"03",eyebrow:"Lead-path check",title:"Where are your best leads dropping off?",body:"Follow the path from first visit to booked conversation and identify where attention, trust, or follow-up starts to break down.",button:"Map my lead path",proof:["Visitor journey","Conversion gaps","Next best fix"]},
    campaign:{number:"04",eyebrow:"Campaign performance check",title:"Are your campaigns creating momentum—or just clicks?",body:"See whether targeting, creative, landing pages, and lead quality are working together to produce useful business results.",button:"Audit my campaign",proof:["Lead quality","Conversion rate","Budget efficiency"]},
    growth:{number:"05",eyebrow:"Connected growth check",title:"Do your digital channels work as one system?",body:"See how your website, search visibility, campaigns, reputation, and follow-up support one another—and where the system needs attention.",button:"Check my growth system",proof:["Connected view","Priority gaps","Focused roadmap"]},
    search:{number:"06",eyebrow:"Search + AI discovery check",title:"Will customers—and AI—find the right answer?",body:"See where your business appears for high-intent searches, which pages support those answers, and whether AI results can understand your expertise.",button:"Check my search visibility",proof:["Priority queries","Content gaps","AI readiness"]},
    reputation:{number:"07",eyebrow:"Reputation health check",title:"Does your reputation make the next decision feel easy?",body:"Review rating strength, response consistency, recent feedback, and where trust proof appears across your website and local profiles.",button:"Check my reputation",proof:["Review health","Response gaps","Trust placement"]},
    followup:{number:"08",eyebrow:"Follow-up leak check",title:"How many good leads go quiet after they inquire?",body:"Map what happens after a call or form submission and find the delays, missed handoffs, and follow-up gaps that cost conversations.",button:"Map my follow-up",proof:["Response speed","CRM handoffs","Nurture gaps"]},
    content:{number:"09",eyebrow:"Content signal check",title:"Does your content give people a reason to remember you?",body:"See whether the message, publishing rhythm, creative mix, and audience response are building recognition across the channels that matter.",button:"Check my content signal",proof:["Message clarity","Creative mix","Publishing rhythm"]},
    commerce:{number:"10",eyebrow:"eCommerce revenue check",title:"How much revenue is hidden inside avoidable friction?",body:"Follow shoppers from product discovery to purchase and identify where product clarity, trust, checkout, or campaign alignment reduces sales.",button:"Audit my online store",proof:["Product journey","Checkout friction","Revenue opportunity"]}
  };
  const key=conceptByService[service.slug]||"growth", concept=concepts[key];
  const metricRows=items=>`<div class="csp-check-metrics">${items.map(item=>`<div class="csp-check-metric ${item[3]}"><div class="csp-check-metric-head"><span>${esc(item[0])}</span><b>${item[1]}</b><em>${esc(item[2])}</em></div><div class="csp-check-meter" role="img" aria-label="${esc(item[0])}: ${item[1]} out of 100, ${esc(item[2])}"><i style="width:${item[1]}%"></i></div></div>`).join("")}</div>`;
  const visuals={
    website:`<div class="sdc-score"><div><strong>86</strong><small>Website clarity</small></div></div>${metricRows([["First impression",91,"Strong","good"],["Mobile experience",78,"Good","good"],["Conversion path",63,"Watch","warn"]])}`,
    local:`<div class="sdc-map"><i class="p1"></i><i class="p2"></i><i class="p3"></i><i class="p4"></i><div><small>Primary service area</small><strong>74%</strong><span>Visibility coverage</span></div></div>${metricRows([["Profile strength",88,"Strong","good"],["Service-area reach",64,"Opportunity","warn"],["Review signals",81,"Healthy","good"]])}`,
    lead:`<div class="sdc-funnel"><div><span>Website visits</span><b>1,240</b></div><div><span>Engaged visitors</span><b>312</b></div><div><span>Qualified leads</span><b>86</b></div><div><span>Booked conversations</span><b>29</b></div></div><p class="csp-check-sample">Sample journey shown. Your path reflects your calls, forms, pages, and follow-up.</p>`,
    campaign:`<div class="sdc-chart"><svg viewBox="0 0 520 210" preserveAspectRatio="none"><path class="grid" d="M0 42H520M0 92H520M0 142H520M0 192H520"/><path class="area" d="M0 192 L0 170 L55 154 L105 161 L160 118 L212 132 L268 92 L320 103 L375 60 L430 77 L480 38 L520 49 L520 192 Z"/><path class="line" d="M0 170 L55 154 L105 161 L160 118 L212 132 L268 92 L320 103 L375 60 L430 77 L480 38 L520 49"/><circle cx="480" cy="38" r="5"/></svg></div><div class="sdc-kpis"><div><span>Conversion rate</span><strong>6.8%</strong><em>+1.7%</em></div><div><span>Qualified leads</span><strong>47</strong><em>+12</em></div><div><span>Cost per lead</span><strong>$42</strong><em>-18%</em></div></div>`,
    growth:`<div class="sdc-system"><svg viewBox="0 0 500 250"><line x1="250" y1="125" x2="80" y2="50"/><line x1="250" y1="125" x2="420" y2="50"/><line x1="250" y1="125" x2="75" y2="205"/><line x1="250" y1="125" x2="425" y2="205"/><line x1="250" y1="125" x2="250" y2="235"/></svg><div class="center"><strong>79</strong><small>System health</small></div><span class="n1">Website</span><span class="n2">Visibility</span><span class="n3">Campaigns</span><span class="n4">Reputation</span><span class="n5">Follow-up</span></div>`,
    search:`<div class="sdc-search-list"><article><span>Best [service] near me</span><small>Google position</small><b>#7 · Not cited</b></article><article><span>Emergency [service]</span><small>Google position</small><b>#3 · Cited</b></article><article><span>Who offers [service]</span><small>Google position</small><b>#18 · Partial</b></article><article><span>[Service] pricing guide</span><small>Google position</small><b>Missing</b></article></div><div class="sdc-summary"><div><span>Search coverage</span><strong>62%</strong></div><div><span>AI citations</span><strong>1 / 4</strong></div><div><span>Content gaps</span><strong>6</strong></div></div>`,
    reputation:`<div class="sdc-trust"><div class="score"><strong>4.6</strong><small>Average rating</small></div><div><div class="stars">★★★★★</div><p>Strong rating. Response speed and website proof create the largest opportunity.</p></div></div><div class="sdc-bars"><article><span>Rating strength</span><i style="--bar:92%"></i><b>92</b></article><article><span>Review recency</span><i style="--bar:74%"></i><b>74</b></article><article><span>Owner responses</span><i style="--bar:46%"></i><b>46</b></article><article><span>Website proof</span><i style="--bar:38%"></i><b>38</b></article></div>`,
    followup:`<div class="sdc-automation"><article><span>01</span><div><h4>New inquiry captured</h4><p>Form, call, chat, or campaign lead</p></div><b>100%</b></article><article><span>02</span><div><h4>Immediate confirmation</h4><p>Email or text acknowledges the request</p></div><b>84%</b></article><article><span>03</span><div><h4>Human follow-up</h4><p>Owner or sales team makes contact</p></div><b>51%</b></article><article><span>04</span><div><h4>Conversation booked</h4><p>Qualified lead reaches the next step</p></div><b>29%</b></article></div><div class="sdc-leak"><span>Largest leak</span><strong>Human follow-up · 33%</strong></div>`,
    content:`<div class="sdc-content"><article class="active"><span>Mon</span><b>Service story</b></article><article><span>Tue</span><b>Client proof</b></article><article class="active"><span>Wed</span><b>Short-form video</b></article><article><span>Thu</span><b>Expert answer</b></article><article><span>Fri</span><b>Local signal</b></article><article class="active"><span>Sat</span><b>Behind the scenes</b></article><article><span>Sun</span><b>Community reply</b></article><article class="active"><span>Next</span><b>Paid promotion</b></article></div><div class="sdc-summary"><div><span>Consistency</span><strong>71</strong></div><div><span>Engagement</span><strong>3.8%</strong></div><div><span>Content gaps</span><strong>4</strong></div></div>`,
    commerce:`<div class="sdc-commerce"><article><span>Sessions</span><strong>8,420</strong><small>100%</small></article><article><span>Product views</span><strong>3,180</strong><small>37.8%</small></article><article><span>Add to cart</span><strong>824</strong><small>25.9%</small></article><article><span>Checkout</span><strong>391</strong><small>47.5%</small></article><article><span>Purchase</span><strong>246</strong><small>62.9%</small></article></div><div class="sdc-opportunity"><p>Illustrative monthly opportunity from stronger product confidence and cart recovery.</p><strong>+$18.4K</strong></div>`
  };
  return `<section class="csp-performance-check sdc sdc-concept-${key}" id="service-diagnostic" data-diagnostic-concept="${concept.number}" data-nav-theme="dark"><div class="shell csp-check-grid"><div class="csp-check-copy"><p class="section-tag">${concept.eyebrow}</p><h2>${concept.title}</h2><p>${concept.body}</p><a class="pill pill-blue pill-large" href="${path("contact.html")}">${concept.button} <span>↗</span></a><div class="csp-check-proof">${concept.proof.map(item=>`<span>${item}</span>`).join("")}</div></div><div class="csp-check-card" aria-label="Example ${concept.eyebrow} snapshot"><div class="csp-check-card-head"><p>Example ${concept.eyebrow} snapshot</p><b>${concept.number} / ${esc(service.name)}</b></div>${visuals[key]}${key==="content"?`<div class="sdc-content-insights"><p class="sdc-insights-label">Example priorities for the next content cycle</p><div class="sdc-content-actions"><article><h3>Strengthen the mix</h3><p>Pair service stories with client proof and answers to common customer questions.</p></article><article><h3>Give attention a next step</h3><p>Use a clear call to action, then review saves, replies, and qualified inquiries.</p></article></div><p class="sdc-content-disclaimer">Illustrative data only. Your review is based on your channels, audience, and goals.</p></div>`:""}</div></div></section>`;
}
